...
- 六主题 105 个 NORMAL 等级已入图；当前 35 条攻击、防御和生命效果具有 `DIFFICULTY_EFFECT_ENTERS_ZONE`，其余原文继续保留为未分类事实。
...
- 整理 `rogue_4`、`rogue_5` 主题特殊系统的当前状态、数值、目标和条件模型。
- `rogue_6` 已建立实托邦、乌托邦 Buff 和概念体报告契约；仍需补充“倾斜沙丘”等条件效果的运行时状态模型。
