...
const NODE_TABLES = [
  ...
  "CREATE NODE TABLE DifficultyTechnology(id STRING, topic STRING, buffId STRING, name STRING, description STRING, jsonPath STRING, PRIMARY KEY(id))",
...
const REL_TABLES = [
  ...
  "CREATE REL TABLE DIFFICULTY_ENABLES_TECHNOLOGY(FROM RogueDifficulty TO DifficultyTechnology, buffId STRING, evidencePath STRING)",
